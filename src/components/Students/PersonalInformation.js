...
console.log("profile", profile)
  ...
  return (
    <div className="p-4 space-y-6  mx-auto">
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
            ...
            <div className="mb-4">
              <label className="block text-sm mb-1 text-gray-700">Marital Status</label>
              <Select
              name="maritalStatus"
              ...
              <option value="Single">Single</option>
                ...
                {errors.maritalStatus && <p style={{ color: "red", marginTop: "5px" }}>{errors.maritalStatus.message}</p>}
            </div>
        ...
        <div className="card-body p-12 shadow-md bg-base-100 rounded-md">
          ...
          <div className="text-md">
           ...
           <div className="text-md">
              ...
              <div className="mt-4">
              <span className="text-gray-600">Postal Code</span><br/>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="text-md">
      <div className="mb-4">
        <label className="block text-sm mb-1 text-gray-700">Address 1</label>
        <Input
          type="text"
        ...
        {errors.mailingAddress1 && (
          <p className="text-red-500 text-sm mt-1">{errors.mailingAddress1.message}</p>
        )}
      </div>
      <div className="mb-4">
        ...
        {errors.mailingCountry && (
          <p className="text-red-500 text-sm mt-1">{errors.mailingCountry.message}</p>
        )}
      </div>
      <div className="mb-4">
        ...
        />
        {errors.mailingCity && (
          <p className="text-red-500 text-sm mt-1">{errors.mailingCity.message}</p>
        )}
      </div>
    </div>
    ...
    <div className="text-md">
      <div className="mb-4">
        <label className="block text-sm mb-1 text-gray-700">Address 2</label>
        <Input
          type="text"
        ...
        {errors.mailingAddress2 && (
          <p className="text-red-500 text-sm mt-1">{errors.mailingAddress2.message}</p>
        )}
      </div>
      <div className="mb-4">
        ...
        />
        {errors.mailingState && (
          <p className="text-red-500 text-sm mt-1">{errors.mailingState.message}</p>
        )}
      </div>
      <div className="mb-4">
        ...
        {errors.mailingPostalCode && (
          <p className="text-red-500 text-sm mt-1">{errors.mailingPostalCode.message}</p>
        )}
      </div>
    </div>
  </div>
    ...
    <div className="text-md">
      <div className="mb-4">
        ...
        {errors.permanentAddress1 && (
          <p className="text-red-500 text-sm mt-1">{errors.permanentAddress1.message}</p>
        )}
      </div>
      <div className="mb-4">
        <label className="block text-sm mb-1 text-gray-700">Country</label>
        ...
        {errors.permanentCountry && (
          <p className="text-red-500 text-sm mt-1">{errors.permanentCountry.message}</p>
        )}
      </div>
      <div className="mb-4">
        <label className="block text-sm mb-1 text-gray-700">City</label>
        ...
        {errors.permanentCity && (
          <p className="text-red-500 text-sm mt-1">{errors.permanentCity.message}</p>
        )}
      </div>
    </div>
    ...
    <div className="text-md">
      <div className="mb-4">
        ...
        {errors.permanentAddress2 && (
          <p className="text-red-500 text-sm mt-1">{errors.permanentAddress2.message}</p>
        )}
      </div>
      <div className="mb-4">
        <label className="block text-sm mb-1 text-gray-700">State</label>
        ...
        {errors.permanentState && (
          <p className="text-red-500 text-sm mt-1">{errors.permanentState.message}</p>
        )}
      </div>
      <div className="mb-4">
        <label className="block text-sm mb-1 text-gray-700">Postal Code</label>
        ...
        {errors.permanentPostalCode && (
          <p className="text-red-500 text-sm mt-1">{errors.permanentPostalCode.message}</p>
        )}
      </div>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div className="text-md">
      ...
      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">Issue Country</label>
        <Input
          type="text"
        ...
        {errors.passportIssueCountry && (
          <p className="text-red-500 text-sm mt-1">{errors.passportIssueCountry.message}</p>
        )}
      </div>
    </div>
    ...
    <div className="text-md">
      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">Issue Date</label>
        <input
          type="date"
      ...
      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">City of Birth</label>
        <input
          type="text"
        ...
        {errors.passportCityOfBirth && (
          <p className="text-red-500 text-sm mt-1">{errors.passportCityOfBirth.message}</p>
        )}
      </div>
    </div>
    ...
    <div className="text-md">
      ...
      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">Country of Birth</label>
        <input
          type="text"
        ...
        {errors.passportCountryOfBirth && (
          <p className="text-red-500 text-sm mt-1">{errors.passportCountryOfBirth.message}</p>
        )}
      </div>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="text-md">
      ...
      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">Is the applicant a citizen of more than one country?<span className="text-red-500">*</span></label>
        <select
        ...
        {errors.isMultiCitizenship && (
          <p className="text-red-500 text-sm mt-1">{errors.isMultiCitizenship.message}</p>
        )}
      </div>
    </div>
    ...
    <select
      ...
      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">Is the applicant living and studying in any other country?<span className="text-red-500">*</span></label>
        <select
        ...
        {errors.isStudyOrLivingOtherCountry && (
          <p className="text-red-500 text-sm mt-1">{errors.isStudyOrLivingOtherCountry.message}</p>
        )}
      </div>
    </div>
  </div>
  ...
  <Button type="submit" className="btn" style={{backgroundColor:"#C71320"}}>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="card-body p-12 shadow-md bg-base-100 rounded-md">
          ...
          <div className="text-md">
              <div>
              <span className="text-gray-600">Has applicant applied for any type of immigration into any country?</span><br/>
              <span>{profile?.isAppliedAnyImmigrationBefore}</span>
              </div>
              <div className="mt-4">
              <span className="text-gray-600">Has applicant Visa refusal for any country?</span><br/>
              <span>{profile?.isVisaRefusal}</span>
              </div>
               </div>
          <div className="text-md">
              <div>
              <span className="text-gray-600">Does applicant suffer from a serious medical condition?</span><br/>
              <span>{profile?.isSeriousMedicalCondition}</span>
              </div>
              <div className="mt-4">
              <span className="text-gray-600">Has applicant ever been convicted of a criminal offence?</span><br/>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="text-md">
      <div className="mb-4">
        ...
        Has applicant applied for any type of immigration into any country?<span className="text-red-500">*</span>
        </label>
        <select
        ...
        {errors.isAppliedAnyImmigrationBefore && (
          <p className="text-red-500 text-sm mt-1">{errors.isAppliedAnyImmigrationBefore.message}</p>
        )}
      </div>

      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">
        Has applicant Visa refusal for any country?<span className="text-red-500">*</span>
        </label>
        <select
        ...
        {errors.isVisaRefusal && (
          <p className="text-red-500 text-sm mt-1">{errors.isVisaRefusal.message}</p>
        )}
      </div>
    </div>
    ...
    <div className="text-md">
      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">
        Does applicant suffer from a serious medical condition?<span className="text-red-500">*</span>
        </label>
        <select
        ...
        {errors.isSeriousMedicalCondition && (
          <p className="text-red-500 text-sm mt-1">{errors.isSeriousMedicalCondition.message}</p>
        )}
      </div>

      <div className="mb-4">
        <label className="block text-sm text-gray-700 mb-1">
        Has applicant ever been convicted of a criminal offence?<span className="text-red-500">*</span>
        </label>
        <select
        ...
        {errors.isCriminalOffence && (
          <p className="text-red-500 text-sm mt-1">{errors.isCriminalOffence.message}</p>
        )}
      </div>
    </div>
  </div>
    ...
    <div className="text-md">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="input input-bordered w-full shadow-md p-3"
        />
        {errors.emergencyContactEmail && <p className="text-red-500 text-sm mt-1">{errors.emergencyContactEmail.message}</p>}
      </div>
    </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="text-md">
      <div className="mb-4">
        ...
        ></textarea>
        {errors.gapDetails && (
          <p className="text-red-500 text-sm mt-1">{errors.gapDetails.message}</p>
        )}
      </div>
    </div>
  </div>
