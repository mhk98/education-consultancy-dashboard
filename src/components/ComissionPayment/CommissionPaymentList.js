...
const CommissionCard = ({ data }) => (
  <div
    className={`border rounded-md shadow-sm p-4 mb-4 ${
      data.isActive ? "bg-blue-50 border-blue-400" : "bg-white"
    }`}
  >
    ...
    <p className="text-sm mt-1">
      ...
      <span className="text-blue-700 font-bold">INR {data.amount}</span>
    </p>
    ...
    <div className="p-4 max-w-2xl mx-auto">
      ...
      <div className="flex justify-between items-center mt-4 flex-wrap gap-3">
        <div className="flex items-center space-x-2">
          <button className="px-2 py-1 bg-blue-500 text-white text-sm rounded">
            &lt;
          </button>
